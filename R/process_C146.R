...
ggsave(here(paste0('output/',subject,'/',subject,'_cnv_segment_heatmap.pdf')),width=11,height=4.25)
...
tmp1 <- ape::rotate(tmp1,node=12)
tmp1 <- ape::rotate(tmp1,node=14)
tmp1 <- ape::rotate(tmp1,node=17)
